const UserRow = ({user, userDetails, showDelete, showCreateEdit}) => {
    return (
        <tr>
        <td>
          <img
        ...
        <td className="actions">
          <button onClick={(() => showCreateEdit(user._id))} className="btn edit-btn" title="Edit">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
          ...
          <button onClick={() => showDelete(user._id)} className="btn delete-btn" title="Delete">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
          ...
          <button onClick={() => userDetails(user._id)} className="btn info-btn" title="Info">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
