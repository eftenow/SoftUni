...
export const UserCard = ({
    user,
    onAction, }) => {
    const defaultAvatar = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"
    return (
        <tr>
            <td>
                <img
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onAction(user._id, userActions.edit)}>
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onAction(user._id, userActions.remove)}>
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <button className="btn info-btn" title="Info" onClick={() => onAction(user._id, userActions.details)}>
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
